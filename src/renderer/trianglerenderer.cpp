...
void TriangleRenderer::initResources() {
    ...
    VkMemoryAllocateInfo memAllocInfo = {VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_INFO, nullptr, memReq.size,
    ...
    VkVertexInputAttributeDescription vertexAttrDesc[] = {
        ...
        {1,                                             // location
         0,                                             // binding
         VK_FORMAT_R32G32B32_SFLOAT, 2 * sizeof(float)} //
    };
    ...
    VkPipelineShaderStageCreateInfo shaderStages[2] = {{VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO, nullptr, 0,
